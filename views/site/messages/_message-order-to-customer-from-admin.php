...
<div class="mainBlock">
    ...
    <p>
        Напоминаем, что ваш заказ №<?= $order->id ?> от <?= date('d.m.Y', $order->updated_at); ?>  размещён на портале «Valinta.ru» и может быть обновлён в любое
        удобное для вас время.<br><br>
