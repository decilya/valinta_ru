...
<div class="mainBlock">
	...
	<p>С радостью сообщаем, что вы зарегистрированы на сайте бесплатных объявлений для специалистов по сметному делу «Valinta.ru». Ваша анкета проходит проверку нашими менеджерами. Внести необходимые изменения в анкету вы всегда можете в Личном кабинете сметчика (ЛК).</p>

	<p class="parameters">Параметры доступа в ЛК:</p>
	<ul>
		<li><strong>Логин: </strong><?= $user->email ?></li>
	</ul>
