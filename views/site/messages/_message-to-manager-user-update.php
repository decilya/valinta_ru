...
<p>На сайте бесплатных объявлений для специалистов сметного дела «Valinta.ru» обновлена анкета №<?= $user->real_id ?>.</p>
...
<table cellpadding="5">
	...
	<tr>
		<td>Дата/Время обновления:</td><td><?= date('d.m.Y H:i:s',$user->date_changed) ?></td>
	</tr>
	<tr>
