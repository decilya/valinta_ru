...
<div class="mainBlock">
    ...
    <p style="font-family: Arial, sans-serif;">С сожалением сообщаем, что Ваш заказ №<?= $order->id; ?> от <?= date('d.m.Y', $order->updated_at) ?>
        не прошёл проверку нашими менеджерами и был закрыт.<br><br>

        <strong>Причина закрытия</strong>: <?= $order->closing_reason_text; ?><br><br>

        В случае возникновения каких-либо вопросов, пожалуйста, свяжитесь с нами по
        телефону: <?= Yii::$app->params['mainSystemPhone']; ?><br><br>
    </p>
    <p class="regards" style="font-family: Arial, sans-serif;font-size: 16px;font-style: italic;text-align: right;">
        С уважением,<br>
        команда Valinta.ru
    </p>
