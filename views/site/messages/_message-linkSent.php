...
<div class="mainBlock">
	...
	<p class="text">Чтобы <?= (!$sentByAdmin) ? 'восстановить пароль' : 'восстановить пароль' ?> от личного кабинета пользователя, перейдите по <a href="<?= Yii::$app->request->hostInfo ?>/change-pass/<?= $recovery_token ?>">ссылке.</a></p>

	<?php if(!$sentByAdmin) : ?>
	<p class="parameters">
		Внимание!
	</p>
	<p>Если вы не предпринимали никаких мер для восстановления пароля, оставьте это сообщение без внимания и не переходите по ссылке.</p>
	<?php endif; ?>
