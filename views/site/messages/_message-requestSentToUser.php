...
<div class="mainBlock">
    ...
    <h2 style="font-family: Arial, sans-serif; font-weight: 400;background-color: #1083ab;padding: 10px 0;color: #FFF; text-align: center;">Уважаемый(ая) <?= $request->fio ?>!</h2>
    <p class="text" style="font-family: Arial, sans-serif;">С радостью сообщаем, что Ваша заявка №<?= $request->id ?> на доступ к ПП SmetaWizard успешно
        сформирована. Наши менеджеры с Вами свяжутся!</p>

    <p class="parameters">Параметры заявки:</p>
    <ul>
        ...
        <li>
            <strong>Нормативные базы: </strong><?php
    ...
    <div style='font-size: 14px; text-align: center;'>
        <p style="font-family: Arial, sans-serif;font-size: 14px;text-align: center;">Данное письмо создано и отправлено автоматически, не нужно на
            него отвечать.</p>
    </div>
</div>
