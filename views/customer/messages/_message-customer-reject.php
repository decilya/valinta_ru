...
<div class="mainBlock">
    ...
    <h2>Уважаемый(ая) <?= $customer->name ?>!</h2>

    <p class="text">С сожалением сообщаем, что ваш профиль заказчика №<?= $customer->real_id; ?> на сайте бесплатных
        объявлений для специалистов
        по сметному делу «Valinta.ru» не прошел проверку и был отклонён. Все размещенные вами заказы закрыты.
    </p>

    <p>Причина: <?= $customer->reason ?></p>

    <p class="parameters">
        Внимание!
    </p>

    <p>Внести необходимые изменения в профиль вы всегда можете в Личном кабинете заказчика.</p>
