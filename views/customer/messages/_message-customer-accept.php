...
<div class="mainBlock">
    ...
    <p class="text">С радостью сообщаем, что ваш профиль на сайте бесплатных объявлений для специалистов
        по сметному делу «Valinta.ru» успешно прошел проверку нашими менеджерами.
    </p>
