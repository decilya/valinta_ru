...
<div class="mainBlock">
	...
	<p class="text">Чтобы <?= (!$sentByAdmin) ? 'завершить процесс восстановления пароля' : 'восстановить пароль' ?> от личного кабинета пользователя,
        перейдите по <a href="<?= Yii::$app->request->hostInfo ?>/change-pass/<?= $recovery_token ?>">ссылке</a></p>
