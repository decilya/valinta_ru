...
<div class="mainBlock">
    ...
    <p class="text">С сожалением сообщаем, что заказ №<?= $order->id ?>, на который Вы откликнулись, не прошел проверку нашими менеджерами
        и был отклонён по причине нарушения правил портала.
    </p>
