...
<div class="mainBlock">
	...
	<p class="text">С радостью сообщаем, что ваша анкета на сайте бесплатных объявлений для специалистов по сметному делу «Valinta.ru» прошла проверку и опубликована.</p>
	<p class="parameters">
		Внимание!
	</p>
	<p style="padding-left: 30px">Внести необходимые изменения в анкету вы всегда можете в Личном кабинете сметчика.</p>
