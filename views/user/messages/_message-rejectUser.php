...
<div class="mainBlock">
	...
	<p class="text">С сожалением сообщаем, что ваша анкета на сайте бесплатных объявлений для специалистов по сметному делу «Valinta.ru» не прошла проверку и не была опубликована.</p>
	<p class="text">Причина: <?= $user->reject_msg ?></p>
    <p class="parameters">
		Внимание!
	</p>
		<p>Напоминаем, что внести необходимые изменения в анкету вы всегда можете в Личном кабинете сметчика.</p>
	<p class="regards">С уважением,<br />команда Valinta.ru</p>
    <div style='font-size: 14px; text-align: center;'>
        Данное письмо создано и отправлено автоматически, не нужно на него отвечать.
    </div>
</div>
