...
$I->wantTo('Проверяю редактирование формы сметчика из личного кабинета - все поля. Статус на модерации.');
...
$I->amGoingTo('Проверяю отправку формы со всеми значениями'); // ------------------------------------------------
...
$Docs=['Локальная смета'];
$Bases=['ТЕР-2001'];
lkSmet4ikPage::of($I)->Update($FIO,$Email,$Phone,$City,$Profs,$Docs,$Bases,$IPAP,$Price,$Exp);
if (method_exists($I, 'wait')) { $I->wait(1); } // only for selenium
