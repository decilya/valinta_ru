...
$I->wantTo('Проверяю редактирование формы сметчика из личного кабинета - обязательные поля. Статус подтверждена.');
...
$username='tiasout@rambler.ru';
$password='1qwe2qaz';
LoginPage::of($I)->Login($username,$password);
if (method_exists($I, 'wait')) { $I->wait(1); } // only for selenium
lkSmet4ikPage::of($I)->FastCheckPage($ID);
lkSmet4ikPage::of($I)->CheckStatus($Status,$WhyCancel);
